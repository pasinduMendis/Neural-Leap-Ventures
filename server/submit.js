...
exports.handler = async (event, context) => {
  ...
  try {
    mongoose.connect(process.env.MONGO_URI ||"mongodb+srv://Neural-Leap-Ventures:Neural-Leap-Ventures@neural-leap-ventures.3ugshp3.mongodb.net/?retryWrites=true&w=majority");
